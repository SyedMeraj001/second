...
// Get device status
app.get('/api/iot/devices/status', (_, res) => {
...
app.get('/api/iot/metrics/realtime', (_, res) => {
  const metrics = {
    environmental: {
...
// Get ESG impact
app.get('/api/iot/metrics/esg-impact', (_, res) => {
  const impact = {
    environmental: {
...
app.get('/api/iot/devices/analytics', (_, res) => {
  const analytics = {
