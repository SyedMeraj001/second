...
// @ts-ignore - sqlite3 module doesn't have TypeScript declarations
// Lazy load modules
...
// Secure database path with path traversal protection
const getSecureDbPath = () => {
  const dbPath = path.join(process.cwd(), 'database', 'esg.db');
...
/**
 * Test API endpoints with proper error handling and CSRF protection
 */
async function testAPIEndpoints() {
  ...
  try {
    ...
    // Test admin endpoints with CSRF protection
