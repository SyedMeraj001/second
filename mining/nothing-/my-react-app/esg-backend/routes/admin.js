...
// View all users
router.get('/users', requirePermission(PERMISSIONS.ADMIN_ACCESS), (req, res) => {
...
// View all companies
router.get('/companies', requirePermission(PERMISSIONS.ADMIN_ACCESS), (req, res) => {
...
// View all ESG data
router.get('/esg-data', requirePermission(PERMISSIONS.ADMIN_ACCESS), (req, res) => {
  db.all(`
...
// View all ESG scores
router.get('/esg-scores', requirePermission(PERMISSIONS.ADMIN_ACCESS), (req, res) => {
  db.all(`
...
// Database stats
router.get('/stats', requirePermission(PERMISSIONS.ADMIN_ACCESS), (req, res) => {
  db.serialize(() => {
    const stats = {};
