        ...
        <div className={`p-4 rounded-lg border-l-4 border-purple-500 ${theme.bg.subtle}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              ...
              aria-label="Total Board Members"
            ...
            <input
              ...
              aria-label="Independent Directors"
            ...
            <input
              ...
              aria-label="Executive Directors"
            ...
            <input
              ...
              aria-label="Non-Executive Directors"
        ...
        <div className={`p-4 rounded-lg border-l-4 border-green-500 ${theme.bg.subtle}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              ...
              aria-label="Mining Industry Expertise"
            ...
            <input
              ...
              aria-label="Environmental Expertise"
            ...
            <input
              ...
              aria-label="Community Relations Expertise"
            ...
            <input
              ...
              aria-label="Geology Technical Expertise"
        ...
        <div className={`p-4 rounded-lg border-l-4 border-yellow-500 ${theme.bg.subtle}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                id="safety_committee_exists"
                checked={formData.safety_committee_exists}
                onChange={(e) => handleInputChange('safety_committee_exists', e.target.checked)}
                className="rounded"
              />
              <label htmlFor="safety_committee_exists" className={theme.text.primary}>{'Safety Committee'}</label>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                id="environmental_committee_exists"
                ...
                className="rounded"
              />
              <label htmlFor="environmental_committee_exists" className={theme.text.primary}>{'Environmental Committee'}</label>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                id="community_relations_committee_exists"
                ...
                className="rounded"
              />
              <label htmlFor="community_relations_committee_exists" className={theme.text.primary}>{'Community Relations Committee'}</label>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
        ...
        <div className={`p-4 rounded-lg border-l-4 border-indigo-500 ${theme.bg.subtle}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              ...
              aria-label="Climate Risk Disclosure Score"
            ...
            <input
              ...
              aria-label="Sustainability Governance Score"
            ...
            <input
              ...
              aria-label="ESG Reporting Frequency"
        ...
        <div className={`p-4 rounded-lg border-l-4 border-orange-500 ${theme.bg.subtle}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <input
              ...
              aria-label="Board Meetings Held"
            ...
            <input
              ...
              aria-label="Average Attendance Percentage"
        ...
        <div className={`p-4 rounded-lg ${theme.bg.subtle}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                id="board_evaluation_conducted"
                checked={formData.board_evaluation_conducted}
                onChange={(e) => handleInputChange('board_evaluation_conducted', e.target.checked)}
                className="rounded"
              />
              <label htmlFor="board_evaluation_conducted" className={theme.text.primary}>{t('governance.boardEvaluationConducted')}</label>
            </div>
          </div>
          <textarea
            placeholder="Governance Framework Description"
            aria-label="Governance Framework Description"
