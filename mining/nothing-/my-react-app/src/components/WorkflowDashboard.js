...
const WorkflowDashboard = ({ onClose }) => {
  ...
  const loadWorkflowData = async () => {
    ...
    try {
      const { default: AuditSystem } = await import('../utils/auditSystem');
  ...
  const handleApproveItems = async (selectedItems, comments) => {
    const { default: AuditSystem } = await import('../utils/auditSystem');
  ...
  const handleRejectItems = async (selectedItems, comments) => {
    const { default: AuditSystem } = await import('../utils/auditSystem');
