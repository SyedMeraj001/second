          ...
          <div className="flex items-center space-x-2 flex-shrink-0">
            ...
            <div className="relative">
              ...
              >
                ...
                {totalNotifications > 0 && (
                  <div className="absolute -top-0.5 -right-0.5 w-5 h-5 bg-red-500 rounded-full flex items-center justify-center animate-bounce">
            ...
            <div className="relative flex items-center space-x-2">
              <button
                ...
                className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-green-500 flex items-center justify-center text-white text-sm font-bold hover:scale-110 transition-transform duration-200"
              >
                U
              </button>
