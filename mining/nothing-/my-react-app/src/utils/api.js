...
const apiRequest = async (endpoint, options = {}) => {
  ...
  // Prevent path traversal and ensure endpoint is safe
  ...
  try {
    const response = await fetch(`${API_BASE}${sanitizedEndpoint}`, config);
...
export { apiRequest };
export default { authAPI, esgAPI, healthCheck, apiRequest };